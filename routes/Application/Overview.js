  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        {base.configs.monitEnabled || base.configs.APMEnabled ? <RunningResource  history={this.props.history} APM_URL={this.state.APM_URL} APMChecked={this.state.APMChecked} appData={this.props.appData} /> : ""}
      </Fragment>
    )
  }
}
