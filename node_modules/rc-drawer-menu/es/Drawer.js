...
var Drawer = function (_React$PureComponent) {
  ...
  function Drawer(props) {
    ...
    _this.getChildToRender = function () {
      ...
      var wrapperClassname = classnames(_this.props.className, (_classnames = {}, _defineProperty(_classnames, className + '-' + placement, true), _defineProperty(_classnames, openClassName, open), _classnames));
      var placementPos = placement === 'left' ? width : '-' + width;
      var transform = open ? 'translateX(' + placementPos + ')' : '';
      var contentStyle = (_contentStyle = {
        width: width
      }, _defineProperty(_contentStyle, placement, '-' + width), _defineProperty(_contentStyle, 'transform', transform), _contentStyle);
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          iconChildToRender && React.createElement(
            'div',
            {
...
Drawer.defaultProps = {
  ...
  iconChild: React.createElement('i', { className: 'drawer-button-icon' })
};
