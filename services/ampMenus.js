...
export default {
  ...
  MENUS: [
    ...
    { id: '6', name: '全局导航', icon: 'global', link: '/navigationmanage', resourceId: 'navigationmanage', component: NavigationManage },
    {
      id: '7', name: '机构用户', icon: 'bar-chart', children: [
        { id: '71', name: '机构管理', link: '/orgs', resourceId: "orgs", component: Orgs, exact: true },
    ...
    {
      id: '8', name: '高级设置', icon: 'setting', children: [
        ...
        { id: '83', name: '集群', link: '/setting/cluster', resourceId: 'setting_cluster', cceDepend:true, component: Cluster },
  ...
  SAVE_MODE_MENU:[
    { id:'2',name: '应用列表', icon: 'appstore', link: '/apps', resourceId: 'apps', component:CceAppList},
    { id: '83', name: '集群', icon:'cluster', link: '/setting/cluster', resourceId: 'setting_cluster', component:Cluster },
    { id: '84', name: '镜像', icon:'block', link: '/setting/images', resourceId: 'setting_images', component:Images ,exact:true},
    { id: '85', name: '存储卷', icon:'hdd', link: '/setting/storage', resourceId: 'setting_storage', component:Storages },
    { id: '86', name: '许可信息', icon:'file-text', link: '/setting/license', resourceId: 'setting_license', component:LicenseMessage }
  ],
}