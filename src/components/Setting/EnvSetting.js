...
import { Button,Card,Form,Select,Row,Col,Input,message,Popconfirm,InputNumber,Switch } from 'antd';
...
class EnvSetting extends PureComponent {
  ...
  clearCheckStatus = ()=>{
    this.setState({
      ...
      helpServiceMonitorAddress:null,
      validateServiceMonitorAddress:'',
      validateGatewayHost:'',
        ...
        this.setState({data:arr},()=>{
         // //console.log("onedit",element);  
          setFieldsValue({
            ...
            name:element.name,
            serviceMonitorAddress:element.serviceMonitorAddress,
            serviceMonitorSwitch:element.serviceMonitorSwitch */
          }); 
        });
       // //console.log("onedit",element);
      }
  ...
  checkSubmitValues=(values)=>{
    ...
    if(values.serviceMonitorAddress && !urlReg.test(values.serviceMonitorAddress)){
      this.setState({
        validateServiceMonitorAddress:'error',
        helpServiceMonitorAddress:'请输入正确的服务监控地址'
      })
      return false;
    }
        ...
        newData.forEach(element=>{
          if(element.key === key){
            ...
            if(element.isNew){ //new
              ...
              console.log("values2",values,element);
              addEnv(element).then(()=>{
              ...
              element.isEdit = false;
              Object.assign(element, values);
              console.log("values3",values,element);
                  ...
                  <Fragment>
                    <Form layout="vertical" hideRequiredMark>
                      ...
                      <Row gutter={16}>
                        ...
                        <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
                          <Form.Item label="服务监控地址"
                            validateStatus={this.state.validateServiceMonitorAddress}
                            help={this.state.helpServiceMonitorAddress} >
