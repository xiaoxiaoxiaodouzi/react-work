...
import {Table,Checkbox,Input,Button,Row,Col,message} from 'antd'
    ...
    return(
      <div>
        <Row style={{marginBottom:16}}>
          ...
          <Col span={12}>
            <Button icon="search" type="primary" onClick={() => this.loadData(1,10,this.state.name)} style={{marginLeft:16}}>
                查询
            </Button>
         </Col> 
        </Row>
