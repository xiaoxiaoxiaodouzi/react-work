  ...
  render(){
    ...
    return (
      <Fragment>
        <Row gutter={24} style={{margin:"24px 12px 0px 12px"}}>
          ...
          <Col {...topColResponsiveProps}>
            <ChartCard
              ...
              footer={<Field label="当日访问人数" value={formateValue(todayUVTotal)} />}
              contentHeight={52}
            >
              <MiniBar
                height={52}
        ...
        <RunningResource appId={this.props.appId} appCode={this.props.appCode} history={this.props.history} APM_URL={this.state.APM_URL} APMChecked={this.state.APMChecked}/>
      </Fragment>
    )
  }
}
