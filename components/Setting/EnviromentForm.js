...
class EnviromentForm extends Component {
    ...
    return (
      ...
      >
        <Tabs tabPosition='left' activeKey={this.state.tabActiveKey} onChange={activeKey => this.setState({ tabActiveKey: activeKey })}>
          ...
          <TabPane tab="全局路由" key="6" forceRender={true}>
