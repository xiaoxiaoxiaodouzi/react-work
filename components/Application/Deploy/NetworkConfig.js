...
export default class NetworkConfig extends PureComponent {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (JSON.stringify(nextProps.networkConfigs) !== JSON.stringify(prevState.propsNetworkConfigs)) {
      return { data: [...nextProps.networkConfigs], propsNetworkConfigs: [...nextProps.networkConfigs] };
    }
    return null;
  }
