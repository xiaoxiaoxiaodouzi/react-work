...
import { Table, Card, Modal, Form, Input,message} from 'antd';
    ...
    render() {
        ...
        return (
            <div style={{ margin: 24 }}>
						...
						>
							<Form>
								<FormItem {...formItemLayout} label="连接超时时间"
								>
									{
								...
								<FormItem {...formItemLayout} label="发送超时时间"
								>
									{
								...
								<FormItem {...formItemLayout} label="读取超时时间"
								>
									{
